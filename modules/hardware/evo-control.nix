  ...
  flake.modules.nixos.evo-control =
    ...
    in
    {
      ...
      environment.etc."evo-control/presets/main.toml".text = ''
        ...
        input_gain_db = [33.0, -8.0, -8.0, -8.0]
        phantom = [true, false, false, false]
        input_mute = [false, false, false, false]
        output_mute = false
        mixer = [[-35.0, -20.0, -128.0, -128.0], [-128.0, -128.0, -128.0, -128.0], [-128.0, -128.0, -128.0, -128.0], [-128.0, -128.0, -128.0, -128.0], [-10.0, -128.0, -128.0, -128.0], [-128.0, -10.0, -128.0, -128.0], [-128.0, -128.0, -128.0, -128.0], [-128.0, -128.0, -128.0, -128.0], [-128.0, -128.0, -128.0, -128.0], [-128.0, -128.0, -128.0, -128.0]]
      '';
    };
}
